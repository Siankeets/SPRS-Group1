...
// Check QR parameter
if (!isset($_POST['qr'])) {  // GET -> POST, gpt ver of qrScanner in stud_index uses POST
    die("Invalid QR code.");
}

$qrCode = trim($_POST['qr']); // GET -> POST, gpt ver of qrScanner in stud_index uses POST
...
$conn->select_db('sprs_dummydb'); // change this in hosting (infinityFree)
