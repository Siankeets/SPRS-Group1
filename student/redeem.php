  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .back-btn {
      ...
      color: #071033; font-weight: 700; border: none;
      border-radius: 8px; padding: 10px 18px; cursor: pointer;
      transition: var(--transition); box-shadow: 0 4px 12px rgba(2,6,23,0.35);
    }
    ...
    .redeem-section button {
      ...
      padding: 12px 20px; color: #071033; font-weight: 700; font-size: 15px;
      cursor: pointer; transition: var(--transition); margin: 10px;
      box-shadow: 0 4px 16px rgba(2,6,23,0.4);
    }
    .redeem-section button:hover { transform: translateY(-3px); box-shadow: 0 10px 26px rgba(2,6,23,0.5); }
    ...
    .option-item {
      ...
      padding: 25px 20px; cursor: pointer; transition: var(--transition);
    ...
    .option-item img {
      ...
      border: 2px solid rgba(255,255,255,0.3); margin-bottom: 15px;
    }
    .option-item:hover {
    ...
    footer {
      width: 100%; background: #1e293b; text-align: center;
      padding: 20px 10px; margin-top: auto;
    }
      ...
      <div class="redeem-section" id="redeemFlow">
        ...
        <ul class="option-list">
          <li class="option-item" onclick="selectReward('Free School T-Shirt (100 pts)')">
            <img src="images/tshirt.png" alt="T-Shirt"> Free School T-Shirt (100 pts)
          </li>
          <li class="option-item" onclick="selectReward('School ID Lace (50 pts)')">
            <img src="images/id.png" alt="ID Lace"> School ID Lace (50 pts)
          </li>
          <li class="option-item" onclick="selectReward('Notebook Set (75 pts)')">
            <img src="images/ntbk.png" alt="Notebook Set"> Notebook Set (75 pts)
          </li>
          <li class="option-item" onclick="selectReward('Event Pass (150 pts)')">
            <img src="images/pass.png" alt="Event Pass"> Event Pass (150 pts)
          </li>
        </ul>
      </div>
    </section>
