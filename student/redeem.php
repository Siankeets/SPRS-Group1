...
<body>
  ...
  <div class="redeem-section" id="redeemFlow">
    ...
    <ul class="option-list">
      <li class="option-item" onclick="selectReward('Free School T-Shirt (100 pts)')">Free School T-Shirt (100 pts)</li>
      <li class="option-item" onclick="selectReward('School ID Lace (50 pts)')">School ID Lace (50 pts)</li>
      <li class="option-item" onclick="selectReward('Notebook Set (75 pts)')">Notebook Set (75 pts)</li>
      <li class="option-item" onclick="selectReward('Event Pass (150 pts)')">Event Pass (150 pts)</li>
    </ul>
  </div>
</section>
    </div>
