  ...
  Html5Qrcode.getCameras()
    .then(cameras => {
      ...
      html5QrCode.start(
        ...
        errorMessage => {
          // Suppress noisy scanning errors
          console.log("Scanning...", errorMessage);
        }
      ).then(() => {
        document.getElementById("scanStatus").innerHTML = "📷 Camera active — point it at the QR code.";
      }).catch(err => {
        document.getElementById("scanStatus").innerHTML = "⚠️ Unable to start camera: " + err;
